...
//    private var BOTTOM_COMPENSATION_MARGIN = resources.getDimension(R.dimen.fb_bottom_compensation_margin).toInt()
    private var BOTTOM_COMPENSATION_MARGIN = 0
...
//        }
    ...
    internal fun setMarginBotton(margin: Float?) {
        if (margin == null) return

        this.BOTTOM_COMPENSATION_MARGIN = TypedValue.applyDimension(
