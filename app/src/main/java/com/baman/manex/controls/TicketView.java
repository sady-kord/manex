...
public class TicketView extends View {
    ...
    public static final String TAG = com.vipulasri.ticketview.TicketView.class.getSimpleName();

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({com.vipulasri.ticketview.TicketView.Orientation.HORIZONTAL, com.vipulasri.ticketview.TicketView.Orientation.VERTICAL})
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({com.vipulasri.ticketview.TicketView.DividerType.NORMAL, com.vipulasri.ticketview.TicketView.DividerType.DASH})
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({com.vipulasri.ticketview.TicketView.CornerType.NORMAL, com.vipulasri.ticketview.TicketView.CornerType.ROUNDED})
    ...
    private void doLayout() {
        ...
        if (mOrientation == com.vipulasri.ticketview.TicketView.Orientation.HORIZONTAL) {
            offset = ((top + bottom) / mScallopPosition) - mScallopRadius;

            if (mCornerType == com.vipulasri.ticketview.TicketView.CornerType.ROUNDED) {
            ...
            } else if (mCornerType == com.vipulasri.ticketview.TicketView.CornerType.SCALLOP) {
            ...
            offset = (((right + left) / mScallopPosition) - 0);

            mRect.set(left + offset, bottom - 0, mScallopHeight + offset + left, bottom + 0);
        ...
        if (mOrientation == com.vipulasri.ticketview.TicketView.Orientation.HORIZONTAL) {
            ...
            mDividerStartX = 0 + left + offset;
            mDividerStartY = top + mScallopRadius + mDividerPadding;
            mDividerStopX = 0 + left + offset;
            mDividerStopY = bottom - 0 - mDividerPadding;
        }
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mOrientation = typedArray.getInt(R.styleable.TicketView_ticketOrientation, com.vipulasri.ticketview.TicketView.Orientation.HORIZONTAL);
...
//            mBackground = typedArray.getResourceId(R.styleable.TicketView_ticketBackground,
//                   )
//                    );
            ...
            mDividerType = typedArray.getInt(R.styleable.TicketView_ticketDividerType, com.vipulasri.ticketview.TicketView.DividerType.NORMAL);
            ...
            mCornerType = typedArray.getInt(R.styleable.TicketView_ticketCornerType, com.vipulasri.ticketview.TicketView.CornerType.NORMAL);
    ...
    private void setDividerPaint() {
        ...
        if (mDividerType == com.vipulasri.ticketview.TicketView.DividerType.DASH)
