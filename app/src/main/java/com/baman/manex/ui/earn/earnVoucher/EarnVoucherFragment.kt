...
import com.baman.manex.databinding.FragmentEarnVoucherBinding
...
class EarnVoucherFragment : BaseFragment(),
    Injectable, CustomViewCallBack,
    AdapterCallBack,
    CustomViewScrollCallBack, InternetConnection {

    lateinit var adapter: EarnShowMoreVoucherAdapter
    ...
    lateinit var binding: FragmentEarnVoucherBinding

    lateinit var data: ArrayList<VoucherInsideDto>

    lateinit var sortData: List<SortDto>

    private lateinit var viewModel: EarnVoucherViewModel
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil
            .inflate(inflater, R.layout.fragment_earn_voucher, container, false)
        return binding.root
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(activity!!, viewModelFactory)
            .get(EarnVoucherViewModel::class.java)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)

        adapter = EarnShowMoreVoucherAdapter(appExecutors, itemClickCallback = {
            findNavController().navigate(EarnVoucherFragmentDirections.showDetails(it!!))
        })
    ...
    private fun setFeatureHandle() {
        ...
        binding.feature.search.setOnClickListener {
            findNavController().navigate(EarnVoucherFragmentDirections.search())

        }

        binding.feature.filter.setOnClickListener {
            findNavController().navigate(EarnVoucherFragmentDirections.filter())
        }
    ...
    private fun getSortData() {
        viewModel.sortData.observe(this@EarnVoucherFragment, Observer {
    ...
    private fun getVouchers(page: Int) {
        ...
        viewModel.getResult.observe(this, Observer {
            it.handle(this, requireActivity(), skeletonScreen, null,
