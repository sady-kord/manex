package com.baman.manex.ui.earn.earnVoucher.filter
...
class EarnVoucherFilterFragment : BaseFilterFragment(), Injectable {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.loadFilterData.observe(this@EarnVoucherFilterFragment, Observer { resource ->
