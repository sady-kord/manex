...
class EarnVoucherViewModel @Inject constructor(
    ...
    val getResult: LiveData<Resource<VoucherResultDto>> = Transformations.switchMap(_requestDto) { input ->
    ...
    private fun createInitialFilter() = InitialFilterEarnRequest(minPrice,maxPrice)
