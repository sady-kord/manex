...
import com.baman.manex.ui.earn.EarnVoucherAdapter
...
class EarnVoucherSearchFragment : BaseSearchFragment(), Injectable, InternetConnection,
    CustomViewCallBack {

    @Inject
    lateinit var viewModelFactory: ViewModelFactory

    private lateinit var viewModel: EarnVoucherSearchViewModel

    private lateinit var searchTags: List<SearchTag>

    var adapter by autoCleared<EarnVoucherAdapter>()
    ...
    override fun setup() {
        ...
        adapter = EarnVoucherAdapter(context!!) {
            findNavController().navigate(EarnVoucherSearchFragmentDirections.showDetails(it))
        }
        ...
        viewModel =
            ViewModelProvider(this, viewModelFactory).get(EarnVoucherSearchViewModel::class.java)
